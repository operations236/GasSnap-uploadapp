...
| `red_bull` | **Production-ready** — Killbuck fractional + **Loudonville** `20260824_180544_7bb9a02bb7` inv **2037214470** (4 lines, **$183.79**; cost=PRICE−DISC; **UNITS→Calculated Qty** 24/24/24/12) |
...
| `austintown_dairy` | **Production-ready** — Parma PDF `20260827_180649_ff5063b5d8` inv **897375** (**12** lines / **$364.98** / 17 cases / 44 units; cost=Amount÷Case; units=Total Units; 10-digit Big Hug UPC; crop detect phone+UWN/629-6170; bare ohio 44513 not aliased) |
| `coremark` | Registered |
| `generic` | Fallback |
...
## Current Focus
- **Austintown Dairy (2026-08-27):** production-ready Parma inv **897375** — 12/$364.98; cost=Amount÷Case; Total Units→Calculated Qty; 10-digit UPC; crop detect via 629-6170 / UWN+44513 (bare `ohio 44513` not aliased).
